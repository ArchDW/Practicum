          ...
          <table class="table table-hover table-condensed table-bordered" id="iddatatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($maestros['activo']); ?></td>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    ...
                    <a href="edit_maestro.php?id=<?php echo $maestros['claveD'];?>" class="btn btn-success btn-xs"  title="Activar" data-toggle="tooltip">
