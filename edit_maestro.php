       ...
       <div class="panel-body">
          <form method="post" action="edit_maestro.php?id=<?php echo $e_maestro['claveD'];?>" class="clearfix">
            <div class="form-group">
                <label for="name"><?php echo remove_junk(ucwords($e_maestro['nombre'])); ?></label>
                <input required type="text" class="form-control" name="nombre"  value=<?php echo remove_junk(ucwords($e_maestro['nombre'])); ?> >
            </div>
            <div class="form-group">
                <label for="apellidoAp"><?php echo remove_junk(ucwords($e_maestro['primerAp'])); ?></label>
                <input required type="text" class="form-control" name="primerAp" value=<?php echo remove_junk(ucwords($e_maestro['primerAp'])); ?>>
            </div>
            <div class="form-group">
                <label for="apellidoAm"><?php echo remove_junk(ucwords($e_maestro['SegundoAp'])); ?></label>
                <input required type="text" class="form-control" name ="SegundoAp"  value=<?php echo remove_junk(ucwords($e_maestro['SegundoAp'])); ?>>
            </div>
            <div class="form-group">
                <label for="edad"><?php echo remove_junk(ucwords($e_maestro['edad'])); ?></label>
                <input required type="text" class="form-control" name ="edad"  value="Edad">
            </div>
            <div class="form-group">
                <label for="name"><?php echo remove_junk(ucwords($e_maestro['email'])); ?></label>
                <input required type="email" class="form-control" name ="email"  value=<?php echo remove_junk(ucwords($e_maestro['email'])); ?>>
            </div>
            <div class="form-group">
                <label for="GradoAc"><?php echo remove_junk(ucwords($e_maestro['GradoAc'])); ?></label>
                <input required type="text" class="form-control" name ="GradoAc"  value=<?php echo remove_junk(ucwords($e_maestro['GradoAc'])); ?>>
            </div>
            <div class="form-group">
              <label for="status">Estado</label>
                <select class="form-control" name="status">
                  <option <?php echo 'selected="selected"';?>>Activo</option>
                  <option <?php echo 'selected="selected"';?>>Inactivo</option>
                </select>
            </div>
